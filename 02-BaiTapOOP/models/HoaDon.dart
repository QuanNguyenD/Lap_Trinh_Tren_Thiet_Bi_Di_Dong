...
class HoaDon {
  ...
  HoaDon(this._maHoaDon,this._ngayBan,this._dienThoaiDuocBan,this._soLuongMua,this._giaBanThucTe,this._tenKhachHang,this._soDienThoaiKhach);
  ...
  set soLuongMua(int soLuongMua) {
    if (soLuongMua > 0 && soLuongMua <= _dienThoaiDuocBan.slTonKho) {
